 ...
 * @s1: Repesents the first string to be compared.
 * @s2: Repesents the second string to be compared.
 *
 ...
 * @card: Repesents a pointer to a deck_node_t card.
 *
 * Return: To the numerical value of the card.
 */
char get_value(deck_node_t *card)
{
 ...
 * @deck: Repesents a pointer to the head of a deck_node_t doubly-linked list.
 */
void insertion_sort_deck_kind(deck_node_t **deck)
{
